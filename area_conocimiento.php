...
<li>
  <a href="" class="submenu-toggle">
    ...
    <span>AREA_CONOCIMIENTO</span>
  </a>

  <ul class="nav submenu" style="list-style:none; margin:0; padding:0; background:white; display:none;">
    <li><a href="add_areaC.php" class="submenu-action">AGREGAR_AREA_C</a></li>
    <li><a href="edit_areaC.php" class="submenu-action">EDITAR_AREA_C</a></li>
    <li><a href="delete_areaC.php" class="submenu-action">ELIMINAR_AREA_C</a></li>
    <li><a href="view_areaC.php" class="submenu-action">VER_AREA_C</a></li>
  </ul>
