...
<li>
  ...
  <ul class="nav submenu" style="list-style:none; margin:0; padding:0; background:white; display:none;">
    <li><a href="add_departamento.php" class="submenu-action">AGREGAR_DPTO</a></li>
    <li><a href="edit_departamento.php" class="submenu-action">EDITAR_DPTO</a></li>
    <li><a href="delete_departamento.php" class="submenu-action">ELIMINAR_DPTO</a></li>
    <li><a href="view_departamento.php" class="submenu-action">VER_DPTO</a></li>
  </ul>
