...
<li>
  <a href="asignatura.php" class="submenu-toggle">
    <i class="glyphicon glyphicon-th-large"></i>
    <span>ASIGNATURA</span>
  </a>
  <ul class="nav submenu" style="list-style:none; margin:0; padding:0; background:white;">
      <li><a href="add_asignatura.php" class="submenu-action">AGREGAR_ASIG</a></li>
      <li><a href="edit_asignatura.php" class="submenu-action">EDITAR_ASIG</a></li>
      <li><a href="delete_asignatura.php" class="submenu-action">ELIMINAR_ASIG</a></li>
      <li><a href="view_asignatura.php" class="submenu-action">VER_ASIG</a></li>
  </ul>
</li>
</ul>
