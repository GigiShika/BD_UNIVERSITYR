...
<li>
  ...
  <ul class="nav submenu" style="list-style:none; margin:0; padding:0; background:white; display:none;">
    <li><a href="add_titulacion.php" class="submenu-action">AGREGAR_TITULACION</a></li>
    <li><a href="edit_titulacion.php" class="submenu-action">EDITAR_TITULACION</a></li>
    <li><a href="delete_titulacion.php" class="submenu-action">ELIMINAR_TITULACION</a></li>
    <li><a href="view_titulacion.php" class="submenu-action">VER_TITULACION</a></li>
  </ul>
